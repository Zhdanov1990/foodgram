...
def test_tag_creation():
    tag = Tag.objects.create(name="Тест", color="#FFFFFF", slug="test")
...
def test_recipe_creation():
    ...
    ingr = Ingredient.objects.create(name="Морковь", measurement_unit="г")
    tag = Tag.objects.create(name="Обед", color="#49B64E", slug="lunch")
